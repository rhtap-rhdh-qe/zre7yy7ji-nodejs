...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/zre7yy7ji-nodejs-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.kx-30961c14a2.a41x.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.kx-30961c14a2.a41x.p3.openshiftapps.com}
